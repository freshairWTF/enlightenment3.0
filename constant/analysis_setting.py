...
class ModelFactor:
    ...
    class Finance:
        def __init__(self):
            ...
            self.basic_reports = {
                "资产负债表": [
                    "所有者权益", "负债和所有者权益", "存货", "非流动资产合计", "少数股东权益", "实收资本"
                ],
                "利润表": [
                    "净利润", "归属于母公司所有者的净利润", "利润总额", "营业利润", "营业收入",

                ],
                "现金流量表": [
                    "分配股利、利润或偿付利息所支付的现金", "购买商品、接受劳务支付的现金", "经营活动产生的现金流量净额",
                    "投资活动现金流出小计", "投资活动现金流入小计", "销售商品、提供劳务收到的现金", "支付的其他与经营活动有关的现金",
                    "支付给职工以及为职工支付的现金", "偿还债务支付的现金", "筹资活动现金流出小计", "筹资活动现金流入小计",
                    "购建固定资产、无形资产和其他长期资产支付的现金", "经营活动现金流出小计", "经营活动现金流入小计",
                    "取得借款收到的现金", "取得投资收益所收到的现金", "收到的其他与经营活动有关的现金",
            ...
            self.financial_analysis = {
                ...
                "资本结构": [
                    "金融性负债", "金融性资产", "净经营资产", "经营性流动负债", "经营性流动资产",
                    "经营性营运资本", "经营性长期负债", "经营性长期资产", "净负债", "净经营性长期资产",
    ...
    class Valuation:
        def __init__(self):
            ...
            # 衍生指标
            self.derived_metrics = [
                "市现率倒数", "市销率倒数", "市净率倒数", "实际收益率", "核心利润盈利市值比", "周期市盈率倒数"
            ]
